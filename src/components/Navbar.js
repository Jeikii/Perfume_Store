    ...
    <header className='min-w-[1200px]'>
      <div className='flex h-[60px] justify-between mb-4'>
        ...
        <div className='flex items-center px-[60px] py-10'>
          <Search />
          <div className='text-base xl:text-lg px-7 cursor-pointer'><CiUser size={26}/></div>
          <div className='text-base xl:text-lg px-7 cursor-pointer'><CiShoppingCart size={26}/></div>
        </div>
      </div>
